...
$tituloCompartir = trim((string) ($n['titulo'] ?? 'Noticia'));
...
<?php if ($mostrarCompartir): ?>
          <div class="<?= e($prefijo) ?>-share">
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?= e(rawurlencode($urlCompartir)) ?>" class="share-btn" target="_blank" rel="noopener noreferrer" aria-label="Compartir en Facebook">
            ...
            <a href="https://wa.me/?text=<?= e(rawurlencode($tituloCompartir . ' ' . $urlCompartir)) ?>" class="share-btn" target="_blank" rel="noopener noreferrer" aria-label="Compartir en WhatsApp">
