 ...
 * Compartido por el feed PC y el movil para no duplicar el marcado.
 *
 * Espera en el ambito:
 *   $n         noticia actual (usa id, me_gusta, no_me_gusta)
 *   $misVotos  array noticia_id => valor con los votos de este visitante
 *   $prefijo   'pc' o 'feed', para las clases del contenedor
 */
$noticiaId = (int) $n['id'];
...
<?php if ($mostrarCompartir): ?>
          <div class="<?= e($prefijo) ?>-share">
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?= e(rawurlencode($urlCompartir)) ?>" class="share-btn" target="_blank" rel="noopener noreferrer" data-share-noticia-id="<?= $noticiaId ?>" data-share-destino="facebook" aria-label="Compartir en Facebook">
            ...
            <a href="https://wa.me/?text=<?= e(rawurlencode($urlCompartir)) ?>" class="share-btn" target="_blank" rel="noopener noreferrer" data-share-noticia-id="<?= $noticiaId ?>" data-share-destino="whatsapp" aria-label="Compartir en WhatsApp">
