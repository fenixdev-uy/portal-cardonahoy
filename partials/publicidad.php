...
if (isset($pdo) && $pdo instanceof PDO) {
    try {
        ...
        $stmtPublicidadPortal->execute([date('Y-m-d')]);
        $anunciosPublicables = $stmtPublicidadPortal->fetchAll();
        if ($anunciosPublicables) {
            $anunciosPublicidadActivos = array_map(static function (array $anuncio): array {
