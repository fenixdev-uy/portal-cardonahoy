...
- La tipografía pública se carga desde Google Fonts: **Oswald** para `h1`–`h6` y **Roboto** para textos, controles y contenido editorial. `Arial Narrow`/Arial quedan como fallbacks si el recurso externo no está disponible. El administrador conserva su tipografía independiente.
