...
- [x] Después de cada grupo completo de tres noticias se intercala una fila híbrida con dos anuncios y la noticia siguiente. La posición de la noticia se distribuye de forma pseudoaleatoria pero estable, los anunciantes rotan entre bloques y los tres elementos igualan dimensiones en escritorio ancho; en el rango compacto se reorganizan en dos columnas.
...
- **PC:** después de cada grupo completo de tres noticias se inserta una fila híbrida con la noticia siguiente y dos avisos. La noticia puede quedar a la izquierda, al centro o a la derecha mediante una semilla estable basada en su identidad y el número de bloque; los avisos rotan y también pueden invertir su orden. Desde `1100px` los tres elementos ocupan columnas iguales; entre `769px` y `1099px` la fila responde en dos columnas. Las imágenes publicitarias se muestran completas, sin recorte ni bordes redondeados, y cada pieza lleva la identificación «Publicidad».
