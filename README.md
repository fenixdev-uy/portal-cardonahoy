...
- La tipografía pública se carga desde Google Fonts: **Oswald** con `font-weight: 800` para `h1`–`h6` y **Roboto** para textos, controles y contenido editorial. La distribución actual de Oswald llega hasta 700, por lo que el navegador sintetiza el peso 800 solicitado. `Arial Narrow`/Arial quedan como fallbacks si el recurso externo no está disponible. El administrador conserva su tipografía independiente.
